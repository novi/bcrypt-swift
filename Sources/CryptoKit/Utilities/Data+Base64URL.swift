...
extension Data {
    ...
    internal init?(base64URLEncoded: String, options: Data.Base64DecodingOptions = []) {
    ...
    ///
    /// https://tools.ietf.org/html/rfc4648#page-7
    internal init?(base64URLEncoded: Data, options: Data.Base64DecodingOptions = []) {
        self.init(base64Encoded: base64URLEncoded.base64URLUnescaped(), options: options)
    }
    ...
    internal func base64URLEncodedData(options: Data.Base64EncodingOptions = []) -> Data {
...
extension String {
    ...
    ///
    /// https://tools.ietf.org/html/rfc4648#page-7
    internal func base64URLUnescaped() -> String {
    ...
    ///
    /// https://tools.ietf.org/html/rfc4648#page-7
    internal mutating func base64URLUnescape() {
    ...
    ///
    /// https://tools.ietf.org/html/rfc4648#page-7
    internal mutating func base64URLEscape() {
...
extension Data {
    ...
    ///
    /// https://tools.ietf.org/html/rfc4648#page-7
    internal func base64URLUnescaped() -> Data {
        var data = self
    ...
    ///
    /// https://tools.ietf.org/html/rfc4648#page-7
    internal func base64URLEscaped() -> Data {
        var data = self
